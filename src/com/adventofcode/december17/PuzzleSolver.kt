...
class PuzzleSolver(test: Boolean) : PuzzleSolverAbstract(test) {
    private val targetMinX = input.inputLines.first().substringAfter("target area: x=").substringBefore("..").toInt()
    private val targetMaxX = input.inputLines.first().substringAfter("..").substringBefore(",").toInt()
    private val targetMinY = input.inputLines.first().substringAfter(", y=").substringBefore("..").toInt()
    private val targetMaxY = input.inputLines.first().substringAfterLast("..").toInt()
